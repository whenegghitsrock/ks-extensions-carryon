...
| controllermanager.controller.repository        | Repo of the KubeFed image.                                                                                                                                                         | dockerhub.kubekey.local/kubernetes-multicluster |
...
| controllermanager.webhook.repository           | Repo of the KubeFed image.                                                                                                                                                         | dockerhub.kubekey.local/kubernetes-multicluster |
