...
| global.image.repository | string | `"kubesphereon/argocd"` | If defined, a repository applied to all Argo CD deployments |
...
| dex.image.repository | string | `"kubesphereon/dex"` | Dex image repository |
...
| redis.metrics.image.repository | string | `"registry.cn-beijing.aliyuncs.com/bitnami/redis-exporter"` | redis-exporter image repository |
...
| applicationSet.image.repository | string | `"kubesphereon/argocd-applicationset"` | Repository to use for the application set controller |
