...
| `image.registry`                          | Image registry                                | `dockerhub.kubekey.local`                                       |
...
| `initChownData.image.registry`            | init-chown-data container image registry      | `dockerhub.kubekey.local`                                               |
...
| `sidecar.image.registry`                  | Sidecar image registry                        | `dockerhub.kubekey.local`                          |
...
| `testFramework.image.registry`            | `test-framework` image registry.            | `dockerhub.kubekey.local`                                             |
...
| `downloadDashboardsImage.registry`        | Curl docker image registry                    | `dockerhub.kubekey.local`                                       |
...
| `imageRenderer.image.registry`             | image-renderer Image registry                                                      | `dockerhub.kubekey.local` |
